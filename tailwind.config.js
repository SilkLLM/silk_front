  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        // The marquee track holds four copies of its content, so travelling
        // -25% lands exactly on the start of the second copy: a seamless
        // loop, and four copies (rather than two) stay wider than the
        // viewport on large monitors so the track never runs out of content
        // and visibly snaps back before the loop point is reached.
